...
<script>
  export default {
    computed: {
      authUrl(){
        return "https://trello.com/1/authorize?expiration=never&scope=read,write&callback_method=fragment&name=trellowiki&key=" + this.$store.getters.apiKey + "&return_url=" + window.location.origin + '/'
      }
    },
    methods: {
      logOut(){
